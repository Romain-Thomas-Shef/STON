...
Designed to be user friendly, STON is fully customizable. It is developed in Python using the PySide6 library for the GUI, Pillow and matplotlib [@Hunter:2007] for image display and operation and scikit analysis for deeper image processing. 
